...
export class TabLifecycleHandler {
  ...
  async _initializeOpenTabsFallback() {
    ...
    try {
      ...
      console.log('[TAB_LIFECYCLE] Fallback initialized with', this.openTabs.size, 'tabs (limited)');
    } catch (fallbackError) {
  ...
  _startPeriodicCleanup() {
    ...
    console.log('[TAB_LIFECYCLE] Periodic cleanup started, interval:', OPEN_TABS_CLEANUP_INTERVAL_MS, 'ms');
  }
