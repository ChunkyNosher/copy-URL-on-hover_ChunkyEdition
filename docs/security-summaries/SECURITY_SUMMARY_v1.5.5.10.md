...
- ✅ Uses `Math.random()` for randomness (not cryptographic, but sufficient for anti-collision)
...
3. ⚠️ Continue to only open Quick Tabs from trusted websites (existing limitation)
