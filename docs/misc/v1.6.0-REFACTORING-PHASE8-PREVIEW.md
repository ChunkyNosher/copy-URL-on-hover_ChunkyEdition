...
- **Test:** Create Quick Tab in Tab A → Verify appears in Tab B → Update in Tab B → Verify syncs to Tab A
...
- **Quick Tab Creation:** User action → Content script → Background → Storage → Sync
