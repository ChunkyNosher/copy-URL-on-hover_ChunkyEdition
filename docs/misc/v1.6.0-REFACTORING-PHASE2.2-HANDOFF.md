...
**Status:** Phase 2.2 - IN PROGRESS (ESLint cleanup complete, facade integration
next)  
...
**Note:** Many of these errors will be automatically fixed when we refactor
index.js into the facade pattern. The errors are in code that will be removed or
heavily refactored.

**Recommendation:** Start facade integration immediately. Address remaining
errors only if they block the refactoring.

---

### **Step 3: QuickTabsManager Facade Integration (CRITICAL)**

**Goal:** Refactor `src/features/quick-tabs/index.js` from 1453 lines to ~400
lines
...
Based on `docs/misc/v1.6.0-REFACTORING-PHASE2.1-COMPLETE-HANDOFF.md` (lines
150-462)
...
- ✅ `constructor()` - Will be simplified
...
**Step 5: Manual testing (~1 hour)** Load extension in Firefox and test:
...
- [ ] Container isolation (create Quick Tab in container, verify not visible in
      default)
...
- ❌ Change any existing extracted components (they're complete and tested)
- ❌ Break backward compatibility
- ❌ Remove functionality
- ❌ Skip testing
- ❌ Skip documentation updates
- ❌ Modify this.tabs Map structure (other code depends on it)

### DO:

- ✅ Follow the facade integration plan exactly
...
**Good luck with the facade integration! This is the home stretch of the
refactoring.** 🚀
