...
- **23 ESLint errors** (10 in background.js, 8 in popup.js, 3 in sidebar/panel.js, 1 in sidebar/quick-tabs-manager.js, 1 in tests/__mocks__/browser-storage.js)
...
**Priority 4: tests/__mocks__/browser-storage.js (1 error)**
...
## Task 4: Fix tests/__mocks__/browser-storage.js (1 error)
...
- tests/__mocks__/browser-storage.js: 1 error → 0 errors
...
4. **tests/__mocks__/browser-storage.js** (1 error) - ~30 minutes
...
4. ✅ tests/__mocks__/browser-storage.js: 0 ESLint errors (from 1)
