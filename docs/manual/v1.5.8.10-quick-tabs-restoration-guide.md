...
This document provides comprehensive instructions for restoring Quick Tabs functionality that regressed during the v1.5.8 → v1.5.8.10 refactoring. **Critical:** All fixes must maintain the current modular structure in `src/` directory.
...
function handleQuickTabPositionChange(quickTabId, left, top) {
  ...
  if (positionChangeThrottle[quickTabId] && 
...
function handleQuickTabSizeChange(quickTabId, width, height) {
  ...
  if (sizeChangeThrottle[quickTabId] && 
...
<div class="setting-row">
  ...
  <div class="shortcut-config">
    <input type="text" id="quickTabManagerShortcut" class="setting-input" 
           placeholder="Ctrl+Alt+Z" readonly style="width: 150px;">
...
<head>
  ...
  <link rel="stylesheet" href="popup.html"> <!-- Reuse styles -->
  <style>
    body {
      width: 100%;
      max-width: 900px;
