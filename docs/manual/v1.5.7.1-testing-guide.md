...
Version 1.5.7.1 fixes the critical "Quick Tab immediately closes" bug by
implementing a promise-based save queue architecture as detailed in
`promise-based-save-queue-architecture-v1.5.8.md`.
