...
✅ Console shows `[SLOTS] Reset slot numbering - next Quick Tab will be Slot 1` after Esc  
...
✅ Console in Tab 2 shows `[Runtime] Received UPDATE_QUICK_TAB_FROM_BACKGROUND`  
✅ Background.js console shows `[Background] Updated Quick Tab ... position: (500, 300)`
