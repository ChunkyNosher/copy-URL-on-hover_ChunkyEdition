...
**Current Repository Architecture (v1.5.8.4 - Modular Refactoring Complete):**
- **src/**: Modular source code organized by functionality
  ...
  - **src/features/url-handlers/**: 11 categorized modules with 104 URL handler functions
  - **src/utils/**: Utility modules (debug.js, dom.js, browser-api.js)
- **dist/**: Built/bundled files (generated by Rollup build system)
  - **dist/content.js**: Bundled content script (63KB, down from 180KB - 65% reduction!)
- **background.js** (~970 lines): Tab lifecycle, webRequest headers, storage sync, panel toggle
...
- **manifest.json**: Manifest v2 (webRequestBlocking required) - updated to v1.5.8.4
