...
**Current Repository Architecture (v1.5.8.2 - Modular Refactoring):**
...
- **src/utils/**: Utility modules (debug.js, dom.js, browser-api.js) - Helper functions for debugging, DOM manipulation, browser APIs
- **dist/**: Built/bundled files generated by Rollup (content.js bundled to 63KB from 180KB source)
...
- **Build System**: package.json, rollup.config.js - npm build workflow
- **Legacy**: content-legacy.js (original monolithic file for reference)
