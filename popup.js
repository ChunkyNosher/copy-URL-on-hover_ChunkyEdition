...
const COLOR_INPUTS = [
  {
    textId: "tooltipColor",
    pickerId: "tooltipColorPicker",
    settingKey: "tooltipColor",
  },
  {
    textId: "notifColor",
    pickerId: "notifColorPicker",
    settingKey: "notifColor",
  },
  {
    textId: "notifBorderColor",
    pickerId: "notifBorderColorPicker",
    settingKey: "notifBorderColor",
  },
];
...
function loadSettings() {
  browser.storage.local.get(DEFAULT_SETTINGS, function (items) {
    ...
    document.getElementById("openNewTabSwitchFocus").checked =
      items.openNewTabSwitchFocus;
    ...
    document.getElementById("quickTabMaxWindows").value =
      items.quickTabMaxWindows;
    document.getElementById("quickTabDefaultWidth").value =
      items.quickTabDefaultWidth;
    document.getElementById("quickTabDefaultHeight").value =
      items.quickTabDefaultHeight;
    ...
    document.getElementById("quickTabPersistAcrossTabs").checked =
      items.quickTabPersistAcrossTabs !== false;
    document.getElementById("quickTabCloseOnOpen").checked =
      items.quickTabCloseOnOpen;
    document.getElementById("quickTabEnableResize").checked =
      items.quickTabEnableResize;
    document.getElementById("quickTabUpdateRate").value =
      items.quickTabUpdateRate || 360;
    ...
    document.getElementById("notifBorderColorPicker").value =
      items.notifBorderColor;
...
document.getElementById("saveBtn").addEventListener("click", function () {
  const settings = {
    ...
    openNewTabSwitchFocus: document.getElementById("openNewTabSwitchFocus")
      .checked,
    ...
    quickTabCloseKey:
      document.getElementById("quickTabCloseKey").value || "Escape",
    quickTabMaxWindows: safeParseInt(
      document.getElementById("quickTabMaxWindows").value,
      3,
    ),
    quickTabDefaultWidth: safeParseInt(
      document.getElementById("quickTabDefaultWidth").value,
      800,
    ),
    ...
    quickTabPosition:
      document.getElementById("quickTabPosition").value || "follow-cursor",
    quickTabCustomX: safeParseInt(
      document.getElementById("quickTabCustomX").value,
      100,
    ),
    quickTabCustomY: safeParseInt(
      document.getElementById("quickTabCustomY").value,
      100,
    ),
    quickTabPersistAcrossTabs: document.getElementById(
      "quickTabPersistAcrossTabs",
    ).checked,
    quickTabCloseOnOpen: document.getElementById("quickTabCloseOnOpen").checked,
    quickTabEnableResize: document.getElementById("quickTabEnableResize")
      .checked,
    quickTabUpdateRate: safeParseInt(
      document.getElementById("quickTabUpdateRate").value,
      360,
    ),
    ...
    notifDisplayMode:
      document.getElementById("notifDisplayMode").value || "tooltip",
    ...
    tooltipDuration: safeParseInt(
      document.getElementById("tooltipDuration").value,
      1500,
    ),
    tooltipAnimation:
      document.getElementById("tooltipAnimation").value || "fade",
    ...
    notifDuration: safeParseInt(
      document.getElementById("notifDuration").value,
      2000,
    ),
    notifPosition:
      document.getElementById("notifPosition").value || "bottom-right",
    ...
    notifBorderWidth: safeParseInt(
      document.getElementById("notifBorderWidth").value,
      1,
    ),
...
document
  .getElementById("quickTabPosition")
