...
**Version 1.5.9.0** - A feature-rich Firefox/Zen Browser extension with fully modular architecture for quick URL copying and advanced Quick Tab management with Firefox Container support and Floating Panel Manager.
...
## 📁 Repository Structure (v1.5.9.0 - Modular Architecture Complete)

**Source Files (Full Modular Structure)**:

- **`src/`** - Modular source code
  - **`src/core/`** - Core modules (config.js, state.js, events.js)
  - **`src/features/`** - Feature modules
    - **`src/features/quick-tabs/`** - **NEW** Quick Tabs feature (index.js, quick-tab-window.js, minimized-manager.js)
    - **`src/features/notifications/`** - **NEW** Notifications feature (index.js)
    - **`src/features/url-handlers/`** - 11 categorized URL handler modules (104 handlers total)
  - **`src/ui/`** - **NEW** UI components (components.js, css/)
  - **`src/utils/`** - Utility modules (debug.js, dom.js, browser-api.js)
  - **`src/content.js`** - Main entry point (orchestrates all features)
...
- **Documentation**: `/docs/` folder organized by type:
  ...
  - `/docs/manual/` - Guides and architecture documentation (including `modular-architecture-blueprint.md`)
